...
class InternalClaimsPolicyTest {
    ...
    @Test
    fun `비활성 설정은 키 없이 가능하지만 활성 설정은 충분한 키를 요구한다`() {
        InternalApiSettings()
    ...
    @Test
    fun `키는 문자열 표현에서 숨기고 반환된 배열 수정이 원본에 영향을 주지 않는다`() {
