...
tasks.test {
    exclude("**/DatabaseMigrationIntegrationTest*", "**/SettingsPersistenceIntegrationTest*", "**/SettingsFeatureIntegrationTest*", "**/SettingsCutoverIntegrationTest*", "**/KeywordCatalogIntegrationTest*", "**/ResultJournalIntegrationTest*", "**/LevelTestPersistenceIntegrationTest*")
}
...
tasks.register<Test>("databaseIntegrationTest") {
    ...
    include("**/DatabaseMigrationIntegrationTest*", "**/SettingsPersistenceIntegrationTest*", "**/SettingsFeatureIntegrationTest*", "**/SettingsCutoverIntegrationTest*", "**/KeywordCatalogIntegrationTest*", "**/ResultJournalIntegrationTest*", "**/LevelTestPersistenceIntegrationTest*")
