...
def verify(be_root: Path | None) -> None:
    ...
    require(names == ["V001__create_learner_and_settings.sql", "V002__seed_default_settings.sql", "V003__create_admin_settings_audit.sql", "V004__create_settings_selection_delivery.sql", "V005__create_keyword_catalog.sql", "V006__create_learning_result_journal.sql"], "migration 목록 불일치")
